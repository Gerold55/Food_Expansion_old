...
local register_pie = function(pie, desc)
	...
	minetest.register_node("pie:" .. pie .. "_1", {
		...
		tiles = {
			pie .. "_top.png", pie .. "_bottom.png", pie .. "_side.png",
			pie .. "_inside.png", pie .. "_side.png", pie .. "_side.png"
		},
		...
		node_box = {
			type = "fixed",
			fixed = {-0.25, -0.5, -0.5, 0.5, 0.0625, 0.5},
		},
	...
	minetest.register_node("pie:" .. pie .. "_2", {
		...
		node_box = {
			type = "fixed",
			fixed = {0, -0.5, -0.5, 0.5, 0.0625, 0.5},
		},
...
register_pie("pineapple","Pineapple Upside Down Cake")

minetest.register_craft({
	output = "pie:pineapple_0",
	recipe = {
		{"farming:baking_tray", "farming:pineapple", ""},
...
-- Birthday cake
register_pie("bc", "Birthday Cake")

minetest.register_craft({
	output = "pie:bc_0",
	recipe = {
		{"group:food_cocoa", "group:food_milk", ""},
		{"group:food_sugar", "group:food_egg", "group:food_sugar"},
		{"group:food_flour", "", "group:food_flour"},
	},
	replacements = {{ "mobs:bucket_milk", "bucket:bucket_empty"}}
})
