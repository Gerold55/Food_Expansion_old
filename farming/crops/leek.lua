...
-- leek seeds
minetest.register_node("farming:seed_leek", {
	description = S("Leek Seed"),
	tiles = {"farming_leek_seed.png"},
	inventory_image = "farming_leek_seed.png",
	wield_image = "farming_leek_seed.png",
	drawtype = "signlike",
...
minetest.register_craftitem("farming:leek", {
	...
	groups = {food_leek = 1, flammable = 2},
})
...
-- stage 2
crop_def.tiles = {"farming_leek_2.png"}
minetest.register_node("farming:leek_2", table.copy(crop_def))

-- stage 6
crop_def.tiles = {"farming_leek_3.png"}
crop_def.drop = {
	items = {
		{items = {'farming:leek'}, rarity = 2},
		{items = {'farming:seed_leek'}, rarity = 1},
	}
}
minetest.register_node("farming:leek_3", table.copy(crop_def))

-- stage 7 (final)
crop_def.tiles = {"farming_leek_4.png"}
crop_def.groups.growing = 0
crop_def.drop = {
	items = {
		{items = {'farming:leek'}, rarity = 1},
		{items = {'farming:leek'}, rarity = 3},
		{items = {'farming:seed_leek'}, rarity = 1},
		{items = {'farming:seed_leek'}, rarity = 3},
	}
}
