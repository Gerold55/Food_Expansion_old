...
-- rhubarb seeds
minetest.register_node("farming:seed_rhubarb", {
...
minetest.register_node("farming:rhubarb_2", table.copy(crop_def))-- stage2
...
-- stage 4 (final)
crop_def.tiles = {"farming_rhubarb_4.png"}
...
minetest.register_node("farming:rhubarb_4", table.copy(crop_def))
