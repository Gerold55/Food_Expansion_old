--Node Definitions
minetest.register_node('farming:snare', { --simple way to catch small game
	...
	on_metadata_inventory_put = function(pos, listname, index, stack, player) --yes you can bait with ANYTHING.
		local meta = minetest.env:get_meta(pos)
		minetest.swap_node(pos, {name = 'farming:snare_baited'})
		meta:set_string('formspec', trap_baited)
		meta:set_string('infotext', 'Baited Simple Snare')
	end,
})

minetest.register_node('farming:snare_baited', { --baited trap
	...
	on_metadata_inventory_take = function(pos, listname, index, stack, player)
		local meta = minetest.env:get_meta(pos)
		minetest.swap_node(pos, {name = 'farming:snare'})
		meta:set_string('formspec', trap_empty)
		meta:set_string('infotext', 'Simple Snare')
	end,
...
minetest.register_node('farming:snare_game', { --trap with game
